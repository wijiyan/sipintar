...
<head>
    ...
    <title>Reset Password - Penji PTM</title>
                        ...
                        <div class="card bg-authentication rounded-0 mb-0 w-100">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center p-0">
                                    <img src="<?php echo base_url();?>app-assets/images/pages/reset-password.png" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">Reset Password Akun <?php echo $nama; ?></h4>
                                            </div>
                                        </div>
                                        <p class="px-2">Masukan Password Baru.</p>
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="<?php echo base_url('Lupa_password/reset_password/token/'.$token);?>" method="POST">
                                                    <fieldset class="form-label-group">
                                                        <input type="password" class="form-control" id="user-password" name="password" placeholder="Password" required>
                                                        <label for="password">Password</label>
                                                    </fieldset>
                                                    <fieldset class="form-label-group">
                                                        <input type="password" class="form-control" id="user-confirm-password" name="passconf" placeholder="Konfirmasi Password" required>
                                                        <label for="passconf">Konfirmasi Password</label>
                                                    </fieldset>
                                                    <div class="row pt-2">
                                                        <div class="col-12 col-md-6 mb-1">
                                                            <a href="auth-login.html" class="btn btn-outline-primary btn-block px-0">Login</a>
                                                        </div>
                                                        <div class="col-12 col-md-6 mb-1">
